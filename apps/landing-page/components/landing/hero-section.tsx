...
const words = ["evaluate", "analyze", "screen", "discover"];
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12 py-32 lg:py-40">
        ...
        >
          <span className="inline-flex items-center gap-3 text-sm font-mono text-muted-foreground">
            ...
            Built for venture capital, angels, and accelerators
          </span>
        </div>
        ...
        <div className="mb-12">
          ...
          >
            <span className="block">The AI Venture</span>
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 items-end">
          ...
          >
            Screen startups, interview founders, analyze pitch decks, perform due diligence, and generate investment memos in minutes instead of weeks.
          </p>
          ...
          >
            ...
            >
              <a href={`${process.env.NEXT_PUBLIC_PLATFORM_URL}/register`}>Book a Demo</a>
            </Button>
          </div>
        </div>
